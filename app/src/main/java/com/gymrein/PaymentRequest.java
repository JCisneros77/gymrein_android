...
public class PaymentRequest extends StringRequest {
    ...
    protected Response<String> parseNetworkResponse(NetworkResponse response) {
        PaymentActivity.setStatusCode(response.statusCode);
    ...
    public PaymentRequest(String t,Response.Listener<String> listener, Response.ErrorListener errorListener){
